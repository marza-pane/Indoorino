...
packet_source_standard = (
    ...
    ( 2302,     'status_switch',    'switch sensor stat',           ('name', 'devname','status','level',)),
    ( 2303,     'stat_floodswitch', 'flood switch sensor stat',     ('name', 'devname','status','level',)),
    ( 2304,     'stat_rainswitch',  'rain switch sensor stat',      ('name', 'devname','status','level',)),
